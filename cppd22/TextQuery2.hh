#ifndef __TextQuery2_H__
#define __TextQuery2_H__
#include <iostream>
#include <fstream>
#include <string>
#include <vector>
...
private:
    shared_ptr<vector<string>> _pFile;                          // 保存输入流内容
    shared_ptr<unordered_map<string, int>> _pStrToFreq;         // 单词-词频
    shared_ptr<unordered_map<string, set<int>>> _pStrToLine;    // 单词-出现的行号集合
};
